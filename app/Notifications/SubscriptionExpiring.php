...
class SubscriptionExpiring extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line("A assinatura \"{$this->subscriptionName}\" vence em {$this->daysBefore} dia(s) (em {$this->nextBillingDate}).")
    ...
    {
        return [
            'message' => "A assinatura \"{$this->subscriptionName}\" vence em {$this->daysBefore} dia(s).",
